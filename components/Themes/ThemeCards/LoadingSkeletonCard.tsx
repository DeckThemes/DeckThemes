  ...
  return (
    <>
      <div className={className}>
        <div className="isolate overflow-hidden h-[242.5px] bg-cardLight dark:bg-cardDark rounded-xl relative before:absolute before:inset-0 before:-translate-x-full before:animate-[shimmer_2s_infinite] before:bg-gradient-to-r before:from-transparent before:via-purple-50/30 before:dark:via-purple-50/10 before:to-transparent">
          <div className="bg-cardLight dark:bg-cardDark rounded-xl h-[162.5px] drop-shadow-lg" />
