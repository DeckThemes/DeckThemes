  ...
  return (
    <>
      <div className={className}>
        <div className="relative isolate overflow-hidden rounded-xl bg-cardLight before:absolute before:inset-0 before:-translate-x-full before:animate-[shimmer_2s_infinite] before:bg-gradient-to-r before:from-transparent before:via-purple-50/30 before:to-transparent dark:bg-cardDark before:dark:via-purple-50/10">
          <div className="h-[162.5px] rounded-xl bg-cardLight drop-shadow-lg dark:bg-cardDark" />
          <div className="items-left flex h-[76px] flex-grow flex-col justify-between p-4">
